...
Usage:
  python convert_washington_gt.py raw_gt.txt datasets/washington_handwritten
"""
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python convert_washington_gt.py raw_gt.txt datasets/washington_handwritten", file=sys.stderr)
        sys.exit(1)
